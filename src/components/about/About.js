    ...
    <div className="">
        ...
        <div className="aboutme">
            <p className="animate__slideInLeft" style={{ fontSize: 30 }}>
              Hello and welcome to my page! I'm a full stack web developer with a background in medical
          ...
          <div className="animate__slideInRight">
            <img className="img-fluid profilepic" src={profilepic2} alt="profilepic"></img>
          </div>
        </div>
    </div>
  );
